...
public static native @Cast("const char*") BytePointer CapturyActorStatusString(int i); public static native void CapturyActorStatusString(int i, BytePointer setter);
@MemberGetter public static native @Cast("const char**") PointerPointer CapturyActorStatusString();
...
public static native CapturyImage Captury_getCurrentImage();
...
// returns 1 if successful, 0 otherwise
public static native int Captury_sendCustomPacket(@Cast("const char*") BytePointer pluginName, int size, @Const Pointer data);
public static native int Captury_sendCustomPacket(String pluginName, int size, @Const Pointer data);
...
public static native @Cast("const char*") BytePointer Captury_getHumanReadableMessageType(@Cast("CapturyPacketTypes") int type);
